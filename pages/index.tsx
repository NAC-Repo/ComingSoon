...
const IndexPage = () => (
  <Layout title="NEWAGE is Coming Soon">
    <img
      src="/images/xera.svg"
      alt="Themeptation "
    ...
    <div className="relative z-10 py-6 space-y-16 lg:space-y-32 text-gray-900">
      ...
      <form className="relative z-10 mx-10 lg:max-w-xl lg:mx-auto">
        <input
          type="text"
          placeholder="example@newagecollectives.com"
    ...
    <div className="absolute bottom-5">
      <ul className="flex space-x-3">
        <li>
          <Link href="https://www.instagram.com/newagecollectives?igsh=NGNzZ2t5bWFna2Zl ">
        ...
        <li>
          <Link href="https://newagecollectives.in">
            <a className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-50 transition ease-in-out duration-500 hover:bg-red-500 hover:text-white hover:shadow-lg">
              <svg
                className="w-6 h-6"
                fill="currentColor"
